...
**Архитектурный принцип:** terio минимизирует совокупную стоимость эксплуатации вычислительной системы. Учёт расходов (cost_counters) встроен в каждую запись лога с самого начала.
...
5. Все шаги пишутся в лог с cost_counters. Renderer читает из лога.
...
3. **Стоимость системы.** terio разделяет стоимость внимания пользователя, агента и ОС/программ (cost_counters в логе).
...
**Rust.** CLI-first. UI: Dioxus (webview).
